    ...
    def clean_task_dict(self, task_dict, strict=False):
        ...
        if task_type == 'data_transfer':
            ...
            if not self.check_job_name(dst_tab_name):
                raise ValueError("table name: '%s' invalid" % dst_tab_name)
...
"""
    ...
    def refresh_dags(self, session=None):
        ...
        # print('dag_codes===', dag_codes)
        
        tmp_dir = mkdtemp(prefix="dcmp_deployed_dags_")
        # tmp_dir = "/home/airflow/airflow/dcmp_deployed_dags_834udeii"
